...
@section('content')
            ...
            <div class="col-3 ">
                ...
                <div class="card card-inverse card-info">
                       ...
                       <div class="box bg-info text-center">
                           <h1 class="font-light text-white"><span id="nbr_de_parts"> </span> &nbsp;&nbsp;<i class="fas fa-users"></i></h1>
            ...
            <div class="col-3 ">
                ...
                <div class="card card-warning card-inverse ">
                    ...
                    <div class="box bg-success text-center">
                        <h1 class="font-light text-white"><span id="nbr_de_pros"></span>&nbsp;&nbsp;&nbsp;<i class="fas fa-shopping-cart"></i></h1>
            ...
            <div class="col-3 ">
                ...
                <div class="card card-primary card-inverse ">
                    ...
                    <div class="box bg-primary text-center">
                        <h1 class="font-light text-white"><span id="nbr_de_produits"></span> &nbsp;&nbsp;&nbsp;<i class="fas fa-shopping-cart"></i></h1>
    ...
    <script>
                ...
                var selectedvalueCity = selectBoxCity.options[selectBoxCity.selectedIndex].value;
                    ...
                    var channel = pusher.subscribe('channel-nbrpartenaires');
                    channel.bind('form-parts', function(data) {
                        $.get('getpar/'+selectedvalueCity,function(donne)
                         {
                            $('#nbr_de_parts').html(/*donne.partenaires[0].numberof*/donne[0]['numberof']);
                        });   
                    });

                    var channel = pusher.subscribe('channel-nbrproduits');
                    channel.bind('form-prds', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-prdsperday');
                    channel.bind('form-prdsperday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-pltsparts');
                    channel.bind('form-pltsparts', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-revrest');
                    channel.bind('form-revrest', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-pltsperday');
                    channel.bind('form-pltsperday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-revrestday');
                    channel.bind('form-revrestday', function(data) {
            ...
            setInterval(function () { $.get('getevents/',function(){});  },5000); 
