   ...
   <script>
            ...
            function month()
            {
                ...
                Pusher.logToConsole = true;
                    ...
                    var channel = pusher.subscribe('channel-intprix');
                    channel.bind('form-intprix', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-intprixday');
                    channel.bind('form-intprixday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-modalite');
                    channel.bind('form-modalite', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-modaliteday');
                    channel.bind('form-modaliteday', function(data) {
      ...
      setInterval(function () { $.get('getevents3/'); },5000);
