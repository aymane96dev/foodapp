...
@section('content')
   ...
   <div class="container">
            ...
            <div class="col-3">
                <div class="card card-inverse card-success">
                    ...
                    <div class="box bg-info text-center">
                        <h1 class="font-light text-white"><span id="nbr_de_commandes"> </span> &nbsp;&nbsp;&nbsp;<i class="fas fa-box"></i> </h1>
            ...
            <div class="col-3">
                <div class="card card-inverse card-danger">
                    ...
                    <div class="box bg-success text-center">
                        <h1 class="font-light text-white"><span id="nbr_de_commandes_perday"> </span> &nbsp;&nbsp;&nbsp;<i class="fas fa-box"></i> </h1>
        ...
        <script>
            ...
            function month(){
                ...
                Pusher.logToConsole = true;
                    ...
                    var pusher = new Pusher('8669d3c59bfd6c3f2ec4', {
                        cluster: 'eu',
                        forceTLS: true
                    });
                    
                    var channel = pusher.subscribe('channel-nbrcmmds');
                    channel.bind('form-nbrcmmds', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-cmdsday');
                    channel.bind('form-cmdsday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-cltscmmds');
                    channel.bind('form-cltscmmds', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-cltscmmdsday');
                    channel.bind('form-cltscmmdsday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-ventes');
                    channel.bind('form-ventes', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-ventesday');
                    channel.bind('form-ventesday', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-depquan');
                    channel.bind('form-depquan', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-depquanday');
                    channel.bind('form-depquan', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-sommeens');
                    channel.bind('form-sommeens', function(data) {
                    ...
                    var channel = pusher.subscribe('channel-sommeensday');
                    channel.bind('form-sommeensday', function(data) {
     ...
     setInterval(function () { $.get('getevents2/',function(){ }); },5000);
