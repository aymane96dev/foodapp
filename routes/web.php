...
Route::get('/getevents','CommandController@getevents');
...
Route::get('/getevents2','DashBoard2Controller@getevents2');
...
Route::get('/getevents3','DashBoard3Controller@getevents3');
