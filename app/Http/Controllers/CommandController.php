...
use App\Events\NbrPartenairesEvent;
use App\Events\NbrProduitsEvent;
use App\Events\PrdsPerDayEvent;
use App\Events\PltsPartsEvent;
use App\Events\PltsDayEvent;
use App\Events\RevRestEvent;
use App\Events\RevRestDayEvent;
use App\Events\TabInfosEvent;
...
class CommandController extends Controller
{
   ...
   public function getprdsbyday($id){
    ...
    {
        event(new NbrPartenairesEvent());
        event(new NbrProduitsEvent());
        event(new PrdsPerDayEvent());
        event(new PltsPartsEvent());
        event(new PltsDayEvent());
        event(new RevRestEvent());
        event(new RevRestDayEvent());
        event(new TabInfosEvent());
    }
    ...
    public function getcities(Request $request)
    {
       ...
       //$plts = $this->getpltsparts();
        ...
        'months'=>$months,"ville" => $idcity,"mois" => $idmonth]);
