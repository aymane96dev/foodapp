...
use App\Events\IntPrixEvent;
use App\Events\IntPrixDayEvent;
use App\Events\ModaliteEvent;
use App\Events\ModaliteDayEvent;
...
class DashBoard3Controller extends Controller
{
    ...
    {
         event(new IntPrixEvent());
         event(new IntPrixDayEvent());
         event(new ModaliteEvent());
         event(new ModaliteDayEvent());
    }
