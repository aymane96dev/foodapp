...
use App\Events\NbrCmmdsDayEvent;
use App\Events\NbrCommandesEvent;
use App\Events\CltsCmmdsEvent;
use App\Events\CltsCmmdsDayEvent;
use App\Events\VentesEvent;
use App\Events\VentesDayEvent;
use App\Events\DepQuanEvent;
use App\Events\DepQuanDayEvent;
use App\Events\SommeensEvent;
use App\Events\SommeensDayEvent;
...
class DashBoard2Controller extends Controller
{
   ...
   /* public function getview(){
    ...
    public function getplat(Request $request){
        ...
        return view('statistiques.kpi1',['cities'=>$cities,'mons'=>$mons,'clients' => $clients
    ...
    public function getevents2(){
        ...
        event(new NbrCmmdsDayEvent());
        event(new NbrCommandesEvent());
        event(new CltsCmmdsEvent());
        event(new CltsCmmdsDayEvent());
        event(new VentesEvent());
        event(new VentesDayEvent());
        event(new DepQuanEvent);
        event(new DepQuanDayEvent());
        event(new SommeensEvent());
        event(new SommeensDayEvent());
    }
